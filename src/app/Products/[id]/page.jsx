...
export default async function ProductDetails({ params }) {
  ...
  return (
    <div>
      <div className="flex items-center gap-2 px-10 md:px-20 mt-10 cursor-pointer hover:text-green-600 transition-all">
        <HiArrowNarrowLeft className="text-xl" />
        <a href="allProducts" className="text-gray-700 font-medium text-lg">সকল পণ্যতে ফিরে যাও</a>
      </div>

      <div className="max-w-6xl mx-auto my-8 px-5 grid grid-cols-1 lg:grid-cols-2 gap-10">
